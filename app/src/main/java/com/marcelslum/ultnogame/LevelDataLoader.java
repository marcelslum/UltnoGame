...
public class LevelDataLoader {
    ...
    public static void initLevelsData(){
        ...
        l = new LevelsGroupData(Game.getContext().getResources().getString(R.string.group1name), 1,  nl, nl+levelsQuantity-1, starsToUnblock[0], LevelsGroupData.getLevelsConqueredStars(nl, nl+levelsQuantity-1), Texture.TEXTURE_ICONS, 1);
                // ---------- LEVEL1
                l.addLevel("Nível "+String.valueOf(nl), nl, Texture.TEXTURE_ICONS, 1);
                // ---------- LEVEL2
                nl += 1;
                l.addLevel("Nível "+String.valueOf(nl), nl, Texture.TEXTURE_ICONS, 2);
                // ---------- LEVEL3
                nl += 1;
                l.addLevel("Nível "+String.valueOf(nl), nl, Texture.TEXTURE_ICONS, 3);
                // ---------- LEVEL4
                nl += 1;
                l.addLevel("Nível "+String.valueOf(nl), nl, Texture.TEXTURE_ICONS, 3);
        ...
        l = new LevelsGroupData(Game.getContext().getResources().getString(R.string.group2name), 2, nl, nl+levelsQuantity-1, starsToUnblock[1], LevelsGroupData.getLevelsConqueredStars(nl, nl+levelsQuantity-1), Texture.TEXTURE_ICONS, 2);
                // ---------- LEVEL5
                nl += 1;
                l.addLevel("Nível "+String.valueOf(nl), nl, Texture.TEXTURE_ICONS, 4);
                // ---------- LEVEL6
                nl += 1;
                l.addLevel("Nível "+String.valueOf(nl), nl, Texture.TEXTURE_ICONS, 5);
                // ---------- LEVEL7
                nl += 1;
                l.addLevel("Nível "+String.valueOf(nl), nl, Texture.TEXTURE_ICONS, 6);
                // ---------- LEVEL8
                nl += 1;
                l.addLevel("Nível "+String.valueOf(nl), nl, Texture.TEXTURE_ICONS, 6);
        LevelsGroupData.levelsGroupData.add(l);
        ...
        l = new LevelsGroupData(Game.getContext().getResources().getString(R.string.group3name), 3, nl, nl+levelsQuantity-1, starsToUnblock[2], LevelsGroupData.getLevelsConqueredStars(nl, nl+levelsQuantity-1), Texture.TEXTURE_ICONS, 3);
                // ---------- LEVEL9
                nl += 1;
                l.addLevel("Nível "+String.valueOf(nl), nl, Texture.TEXTURE_ICONS, 7);
                // ---------- LEVEL10
                nl += 1;
                l.addLevel("Nível "+String.valueOf(nl), nl, Texture.TEXTURE_ICONS, 8);
                // ---------- LEVEL11
                nl += 1;
                l.addLevel("Nível "+String.valueOf(nl), nl, Texture.TEXTURE_ICONS, 8);
                // ---------- LEVEL12
        ...
        l = new LevelsGroupData(Game.getContext().getResources().getString(R.string.group4name), 4, nl, nl+levelsQuantity-1, starsToUnblock[3], LevelsGroupData.getLevelsConqueredStars(nl, nl+levelsQuantity-1), Texture.TEXTURE_ICONS, 3);
                // ---------- LEVEL13
                nl += 1;
                l.addLevel("Nível "+String.valueOf(nl), nl, Texture.TEXTURE_ICONS, 9);
                // ---------- LEVEL14
                nl += 1;
                l.addLevel("Nível "+String.valueOf(nl), nl, Texture.TEXTURE_ICONS, 10);
                // ---------- LEVEL15
                nl += 1;
                l.addLevel("Nível "+String.valueOf(nl), nl, Texture.TEXTURE_ICONS, 11);
                // ---------- LEVEL16
                nl += 1;
                l.addLevel("Nível "+String.valueOf(nl), nl, Texture.TEXTURE_ICONS, 11);
                LevelsGroupData.levelsGroupData.add(l);
        ...
        l = new LevelsGroupData(Game.getContext().getResources().getString(R.string.group5name), 5, nl, nl+levelsQuantity-1, starsToUnblock[4], LevelsGroupData.getLevelsConqueredStars(nl, nl+levelsQuantity-1), Texture.TEXTURE_ICONS, 3);
                // ---------- LEVEL17
                nl += 1;
                l.addLevel("Nível "+String.valueOf(nl), nl, Texture.TEXTURE_ICONS, 12);
                // ---------- LEVEL18
                nl += 1;
                l.addLevel("Nível "+String.valueOf(nl), nl, Texture.TEXTURE_ICONS, 13);
                // ---------- LEVEL19
                nl += 1;
                l.addLevel("Nível "+String.valueOf(nl), nl, Texture.TEXTURE_ICONS, 14);
                // ---------- LEVEL20
                nl += 1;
                l.addLevel("Nível "+String.valueOf(nl), nl, Texture.TEXTURE_ICONS, 15);
        LevelsGroupData.levelsGroupData.add(l);
