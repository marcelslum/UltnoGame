                                        ...
                                        animPoints.setOnChangeNotFluid(new Animation.OnChange() {
                                            ...
                                            public void onChange() {
                                                if (g.balls.get(4).numberForAnimation == 1f){
                                                    g.scorePanel.setValue(800, false, 1000, true);
